...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    loadList: function loadList() {
      ...
      if (id) {
        axios__WEBPACK_IMPORTED_MODULE_0___default.a.get('/user/' + id + '/faces').then(function (response) {
          _this.faces = response.data.result ? response.data.result : [];
        });
      }
    },
    faceDelete: function faceDelete(id) {
      var _this2 = this;
      ...
      if (userId) {
        axios__WEBPACK_IMPORTED_MODULE_0___default.a["delete"]('/user/' + userId + '/face/' + id + '/delete').then(function (response) {
          _this2.faces = response.data.result ? response.data.result : [];
        });
      }
    }
  },
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/FaceAdd.vue?vue&type=script&lang=js&":
/*!******************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/FaceAdd.vue?vue&type=script&lang=js& ***!
  \******************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    readURL: function readURL(input) {
      ...
      if (input.target.files && input.target.files[0]) {
        ...
        reader.onload = function (e) {
          ...
          _this.errorfile = false; //$('.findUser').remove();
          //$('.alert').hide();
    ...
    faceLoad: function faceLoad(id) {
      ...
      if (userId) {
        console.log(id);
        axios__WEBPACK_IMPORTED_MODULE_0___default.a.get('/user/' + userId + '/face/' + id).then(function (response) {
          if (response.data.status == 'success') {
            _this2.face = response.data.result;
            _this2.name = _this2.face.name;
            _this2.errorfile = false;

            if (_this2.face.result) {
              _this2.info.text = '';
            } else _this2.info.text = 'Идет обработка данных, результат будет известен через несколько секунд...';
          } else {
            _this2.error.text = response.data.error;
          }
        });
      }
    },
    sendNewFace: function sendNewFace() {
      var _this3 = this;
      ...
      if (userId) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/user/' + userId + '/face/new', formData, config).then(function (response) {
          if (response.data.status == 'success') {
            _this3.face = response.data.result;
            _this3.name = _this3.face.name;
            ...
            _this3.errorfile = false;
            _this3.info.text = 'Данные отправлены, результат будет известен через несколько секунд...';

            _this3.watchReload();
          } else {
            _this3.disableSend = false;
            _this3.error.text = response.data.error; // Сообщаем о проблеме
          }
        });
      }
    },
    sendFace: function sendFace() {
      var _this4 = this;
      ...
      if (userId) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/user/' + userId + '/face/' + this.face.id, data).then(function (response) {
          if (response.data.status == 'success') {
            _this4.face = response.data.result;
            _this4.info.success = 'Данные успешно сохранены...';
          } else {
            _this4.error.text = response.data.error; // Сообщаем о проблеме
          }
        });
      }
    },
    clearFace: function clearFace() {
    ...
    rectangleStyle: function rectangleStyle(box) {
      var k = this.face.k;
      return 'left:' + Math.round(box.x1 * k) + 'px;' + 'top:' + Math.round(box.y1 * k) + 'px;' + 'width:' + Math.round((box.x2 - box.x1) * k) + 'px;' + 'height:' + Math.round((box.y2 - box.y1) * k) + 'px;';
    },
    watchReload: function watchReload() {
      var _this = this;
...
/***/ "./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/FaceAdd.vue?vue&type=style&index=0&id=2b80b869&scoped=true&lang=css&":
/*!*************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader??ref--6-1!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--6-2!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/FaceAdd.vue?vue&type=style&index=0&id=2b80b869&scoped=true&lang=css& ***!
  \*************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, "\n.photo-box[data-v-2b80b869] {\n    width: 100%\n}\n.input-file-row-1[data-v-2b80b869]:after {\n    content: \".\";\n    display: block;\n    clear: both;\n    visibility: hidden;\n    line-height: 0;\n    height: 0;\n}\n.input-file-row-1[data-v-2b80b869] {\n    display: inline-block;\n    margin-top: 25px;\n    position: relative;\n}\nhtml[xmlns] .input-file-row-1[data-v-2b80b869] {\n    display: block;\n}\n* html .input-file-row-1[data-v-2b80b869] {\n    height: 1%;\n}\n.upload-file-container[data-v-2b80b869] {\n    position: relative;\n    width: 400px;\n    height: 300px;\n    overflow: hidden;\n    background-color: #dddddd;\n    border: 2px dotted #aaaaaa;\n    border-radius: 3px;\n    /*background: url(http://i.imgur.com/AeUEdJb.png) center center no-repeat;*/\n    float: left;\n    margin-left: 23px;\n}\n.upload-file-container[data-v-2b80b869]:first-child {\n    margin-left: 0;\n}\n.upload-file-container > img[data-v-2b80b869] {\n    width: 100%;\n    border-radius: 2px;\n    -webkit-border-radius: 2px;\n    -moz-border-radius: 2px;\n}\n.label-loading[data-v-2b80b869] {\n    position: absolute;\n    display: block;\n    left: 0;\n    bottom: 0;\n    width: 100%;\n    height: 100%;\n    text-align: center;\n    padding-top: 142px;\n}\n.upload-file-container-text[data-v-2b80b869] {\n    font-family: Arial, sans-serif;\n    font-size: 12px;\n    color: #719d2b;\n    line-height: 17px;\n    text-align: center;\n    display: block;\n    position: absolute;\n    left: 0;\n    bottom: 0;\n    width: 100%;\n    height: 100%;\n}\n.upload-file-container-text > span[data-v-2b80b869] {\n    border-bottom: 1px solid #719d2b;\n    cursor: pointer;\n}\n.upload-file-container input[data-v-2b80b869] {\n    position: absolute;\n    left: 0;\n    bottom: 0;\n    font-size: 1px;\n    opacity: 0;\n    filter: alpha(opacity=0);\n    margin: 0;\n    padding: 0;\n    border: none;\n    width: 100%;\n    height: 100%;\n    cursor: pointer;\n}\n.findUser[data-v-2b80b869] {\n    position: absolute;\n    border: 2px solid red;\n    background: transparent;\n    z-index: 1000;\n}\n", ""]);
...
/***/ "./node_modules/style-loader/index.js!./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/FaceAdd.vue?vue&type=style&index=0&id=2b80b869&scoped=true&lang=css&":
/*!*****************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/style-loader!./node_modules/css-loader??ref--6-1!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--6-2!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/FaceAdd.vue?vue&type=style&index=0&id=2b80b869&scoped=true&lang=css& ***!
  \*****************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {


var content = __webpack_require__(/*! !../../../node_modules/css-loader??ref--6-1!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/postcss-loader/src??ref--6-2!../../../node_modules/vue-loader/lib??vue-loader-options!./FaceAdd.vue?vue&type=style&index=0&id=2b80b869&scoped=true&lang=css& */ "./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/FaceAdd.vue?vue&type=style&index=0&id=2b80b869&scoped=true&lang=css&");
    ...
    _c(
      ...
      [
        _c("router-link", { attrs: { to: { name: "add" } } }, [
          _vm._v("Добавить новое фото")
        ])
      ],
      1
    ),
    _vm._v(" "),
    _c("h3", [_vm._v("Список биометрических фото")]),
    _vm._v(" "),
            ...
            [
              _c("td", [
                _c("img", {
                  ...
                  attrs: { src: face.imagePrev, alt: "" }
                })
              ]),
              _vm._v(" "),
              _c("td", [_vm._v(_vm._s(face.name))]),
              _vm._v(" "),
              _c("td", { attrs: { colspan: "2" } }, [
                _c(
                  "table",
                  { staticClass: "table" },
                  _vm._l(face.result, function(fit) {
                    return _c("tr", [
                      _c("td", [
                        _vm._v(
                          _vm._s(fit.race) +
                            " " +
                            _vm._s(fit.race_confidence) +
                            "%"
                        )
                      ]),
                      _vm._v(" "),
...
var staticRenderFns = [
  function() {
    ...
    return _c("thead", [
      _c("tr", [
        _c("th", { staticStyle: { width: "100px" } }, [_vm._v("Фото")]),
        _vm._v(" "),
        _c("th", [_vm._v("Наименование")]),
        _vm._v(" "),
        _c("th", { staticStyle: { width: "10%" } }, [_vm._v("Расса")]),
        _vm._v(" "),
        _c("th", { staticStyle: { width: "10%" } }, [_vm._v("Пол")]),
        _vm._v(" "),
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/FaceAdd.vue?vue&type=template&id=2b80b869&scoped=true&":
/*!**********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/FaceAdd.vue?vue&type=template&id=2b80b869&scoped=true& ***!
  \**********************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
    ...
    _c("div", { staticClass: "col-md-12" }, [
      ...
      _c("div", { staticClass: "row" }, [
        _c("div", { staticClass: "col-md-6" }, [
          _c("fieldset", [
            _c("div", { staticClass: "input-file-row-1 photo-box" }, [
              _c(
                "div",
                { staticClass: "upload-file-container" },
                [
                  _vm.errorfile
                    ? _c("span", { staticClass: "label-loading" }, [
                        _c("p", [
                          _vm._v("Щелкните мышкой в это поле для загрузки фото")
                        ])
                      ])
                    : _vm._e(),
                  _vm._v(" "),
                  _c("img", {
                    ref: "imageSrc",
                    staticClass: "image",
                    attrs: { src: _vm.face.imagePrev, alt: "" }
                  }),
                  _vm._v(" "),
                  _c("div", { staticClass: "upload-file-container-text" }, [
                    !_vm.id
                      ? _c("input", {
                          ref: "photo",
                          staticClass: "photo",
                  ...
                  _vm._v(" "),
                  _vm._l(_vm.face.result, function(b) {
                    return _c("span", {
                      staticClass: "findUser",
                      style: _vm.rectangleStyle(b.box)
                    })
                  })
                ],
                2
        ...
        _c("div", { staticClass: "col-md-6" }, [
          _c("div", { staticClass: "form-group" }, [
            _c("label", [_vm._v("Наименование фото")]),
            _vm._v(" "),
            _c("input", {
              directives: [
                {
            ...
            _vm.$v.name.$error
              ? _c("span", { staticClass: "help-block" }, [
                  _vm._v("Поле имени не должно быть пустым!")
                ])
              : _vm._e()
          ]),
          _vm._v(" "),
          _vm.face.result
            ? _c("div", { staticClass: "form-group" }, [
                _c("label", [_vm._v("Биометрические данные")]),
                _vm._v(" "),
                _c(
                  "table",
                  ...
                  [
                    ...
                    _c(
                      "tbody",
                      _vm._l(_vm.face.result, function(fit, i) {
                        return _c("tr", [
          ...
          _vm.error.text
            ? _c("div", { staticClass: "alert alert-danger" }, [
                _c("p", [_vm._v(_vm._s(_vm.error.text))])
              ])
            : _vm._e(),
          _vm._v(" "),
          _vm.info.text
            ? _c("div", { staticClass: "alert alert-info" }, [
                _c("p", [_vm._v(_vm._s(_vm.info.text))])
              ])
            : _vm._e(),
          _vm._v(" "),
          _vm.info.success
            ? _c("div", { staticClass: "alert alert-success" }, [
                _c("p", [_vm._v(_vm._s(_vm.info.success))])
              ])
            : _vm._e(),
          _vm._v(" "),
          _vm._m(1),
          _vm._v(" "),
          _c("div", { staticClass: "btn-group m-4" }, [
            !_vm.id
              ? _c(
                  "button",
                  {
                    ...
                    attrs: {
                      type: "button",
                      disabled:
                        _vm.disableSend || _vm.$v.$invalid || _vm.errorfile
                    },
                    on: { click: _vm.sendNewFace }
                  },
            ...
            !_vm.id
              ? _c(
                  "button",
                  {
                    ...
                    attrs: { type: "button", disabled: _vm.disableSend },
                    on: { click: _vm.clearFace }
                  },
                  [_vm._v("Очистить")]
                )
              : _vm._e()
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c(
      "div",
      { staticStyle: { display: "none" }, attrs: { id: "info-block" } },
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("h1", [_vm._v("404 - Страница не найдена")])
}
var staticRenderFns = []
render._withStripped = true
...
_components_App__WEBPACK_IMPORTED_MODULE_6__["default"].router = vue__WEBPACK_IMPORTED_MODULE_0___default.a.router;
new vue__WEBPACK_IMPORTED_MODULE_0___default.a(_components_App__WEBPACK_IMPORTED_MODULE_6__["default"]).$mount('#app');
...
/***/ "./resources/js/components/FaceAdd.vue":
/*!*********************************************!*\
  !*** ./resources/js/components/FaceAdd.vue ***!
  \*********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _FaceAdd_vue_vue_type_template_id_2b80b869_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./FaceAdd.vue?vue&type=template&id=2b80b869&scoped=true& */ "./resources/js/components/FaceAdd.vue?vue&type=template&id=2b80b869&scoped=true&");
/* harmony import */ var _FaceAdd_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./FaceAdd.vue?vue&type=script&lang=js& */ "./resources/js/components/FaceAdd.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _FaceAdd_vue_vue_type_style_index_0_id_2b80b869_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./FaceAdd.vue?vue&type=style&index=0&id=2b80b869&scoped=true&lang=css& */ "./resources/js/components/FaceAdd.vue?vue&type=style&index=0&id=2b80b869&scoped=true&lang=css&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  _FaceAdd_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _FaceAdd_vue_vue_type_template_id_2b80b869_scoped_true___WEBPACK_IMPORTED_MODULE_0__["render"],
  _FaceAdd_vue_vue_type_template_id_2b80b869_scoped_true___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  "2b80b869",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/FaceAdd.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/components/FaceAdd.vue?vue&type=script&lang=js&":
/*!**********************************************************************!*\
  !*** ./resources/js/components/FaceAdd.vue?vue&type=script&lang=js& ***!
  \**********************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_FaceAdd_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/babel-loader/lib??ref--4-0!../../../node_modules/vue-loader/lib??vue-loader-options!./FaceAdd.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/FaceAdd.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_FaceAdd_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/components/FaceAdd.vue?vue&type=style&index=0&id=2b80b869&scoped=true&lang=css&":
/*!******************************************************************************************************!*\
  !*** ./resources/js/components/FaceAdd.vue?vue&type=style&index=0&id=2b80b869&scoped=true&lang=css& ***!
  \******************************************************************************************************/
/*! no static exports found */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_FaceAdd_vue_vue_type_style_index_0_id_2b80b869_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/style-loader!../../../node_modules/css-loader??ref--6-1!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/postcss-loader/src??ref--6-2!../../../node_modules/vue-loader/lib??vue-loader-options!./FaceAdd.vue?vue&type=style&index=0&id=2b80b869&scoped=true&lang=css& */ "./node_modules/style-loader/index.js!./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/FaceAdd.vue?vue&type=style&index=0&id=2b80b869&scoped=true&lang=css&");
/* harmony import */ var _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_FaceAdd_vue_vue_type_style_index_0_id_2b80b869_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_FaceAdd_vue_vue_type_style_index_0_id_2b80b869_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_FaceAdd_vue_vue_type_style_index_0_id_2b80b869_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_FaceAdd_vue_vue_type_style_index_0_id_2b80b869_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_FaceAdd_vue_vue_type_style_index_0_id_2b80b869_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default.a); 

/***/ }),

/***/ "./resources/js/components/FaceAdd.vue?vue&type=template&id=2b80b869&scoped=true&":
/*!****************************************************************************************!*\
  !*** ./resources/js/components/FaceAdd.vue?vue&type=template&id=2b80b869&scoped=true& ***!
  \****************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_FaceAdd_vue_vue_type_template_id_2b80b869_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib??vue-loader-options!./FaceAdd.vue?vue&type=template&id=2b80b869&scoped=true& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/FaceAdd.vue?vue&type=template&id=2b80b869&scoped=true&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_FaceAdd_vue_vue_type_template_id_2b80b869_scoped_true___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_FaceAdd_vue_vue_type_template_id_2b80b869_scoped_true___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
...
/* harmony import */ var _components_Page404_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/Page404.vue */ "./resources/js/components/Page404.vue");
/* harmony import */ var _components_FaceAdd__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/FaceAdd */ "./resources/js/components/FaceAdd.vue");
...
/* harmony default export */ __webpack_exports__["default"] = (new vue_router__WEBPACK_IMPORTED_MODULE_0__["default"]({
  routes: [{
    ...
    path: '/face/new',
    name: 'add',
    component: _components_FaceAdd__WEBPACK_IMPORTED_MODULE_2__["default"],
    meta: {
      auth: true
    }
  }, {
    ...
    path: '*',
    name: '404',
    component: _components_Page404_vue__WEBPACK_IMPORTED_MODULE_1__["default"]
  }] //mode: 'history'
...
__webpack_require__(/*! /home/sergey/works/vi1/www/vision/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/sergey/works/vi1/www/vision/resources/sass/app.scss */"./resources/sass/app.scss");
